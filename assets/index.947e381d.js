...
const registerAccount = (email, password, userName) => {
  createUserWithEmailAndPassword(auth, email, password).then((userCredential) => {
    ...
    addDoc(collection(db, "users"), { ...userData, userId }).then(() => {
      alert("Cadastro realizado com sucesso!");
      window.location.hash = "#login";
    }).catch((error) => {
      alert("Falha ao cadastrar usu\xE1rio!", error);
    });
  }).catch((error) => {
    alert("Falha ao cadastrar usu\xE1rio!", error);
  });
...
const loginOn = (email, password) => {
  signInWithEmailAndPassword(auth, email, password).then(async (userCredential) => {
    ...
    if (emailDoUsuario) {
      ...
      console.error("Email do usu\xE1rio n\xE3o encontrado.");
    }
  }).catch((error) => {
    console.error("Falha ao logar usu\xE1rio!", error);
  });
};
const logoutAccount = () => {
  auth.signOut().then(() => {
...
const publishPost = async (publishData, book, userId, genre, age, content) => {
  try {
    ...
    modal.innerHTML = `    
          <div class="modal-content">
            ...
            <form id="request-form">
              ...
              <button type="submit" id="btn-enter">Enviar e-mail de recupera\xE7\xE3o</button>
            </form>
          </div>
      `;
...
const register = () => {
  ...
  function validarFormulario() {
    ...
    if (passwordInput !== confirmPassword) {
      alert("As senhas n\xE3o correspondem. Por favor, tente novamente.");
      return false;
    }
    ...
    if (!/[A-Z]/.test(passwordInput) || !/[a-z]/.test(passwordInput)) {
      alert("A senha deve conter pelo menos uma letra mai\xFAscula e uma min\xFAscula.");
      return false;
    }
    if (!/[0-9]/.test(passwordInput)) {
      alert("A senha deve conter pelo menos um n\xFAmero.");
      return false;
    }
    return true;
  }
  registerForm.addEventListener("submit", (event) => {
    ...
    const nameInput = registerForm.querySelector("#your-name");
    const email = emailInput.value;
    const password = passwordInput.value;
    const name2 = nameInput.value;
    if (validarFormulario()) {
      registerAccount(email, password, name2);
    }
  });
...
const home = () => {
  function openModal() {
    ...
    <div class="janela-modal" id="janela-modal">
        ...
        <h1>WLAMEL BOOK'S</h1>  
        <p> Aqui voc\xEA poder\xE1 compartilhar suas percep\xE7\xF5es, observa\xE7\xF5es e curiosidades dos seus livros, e incentivar a leitura para outras pessoas num espa\xE7o virtual seguro. </p>
        <br>
  ...
  <div class="container-home"> 
    <section class="container-home" id="home">
      ...
      <button id="btn-us">Sobre N\xF3s</button>
...
const feed = () => {
  ...
  function createModal() {
    ...
    modal.innerHTML = `    
     <div class="modal-content">
      <label for="genre">G\xEAnero:</label> 
        <select id="genre" name="genre">
          <option value="fantasia">Fantasia</option>
          <option value="sci-fi">Fic\xE7\xE3o Cient\xEDfica</option>
          <option value="romance">Romance</option>
          <option value="mystery">Mist\xE9rio</option>
          <option value="thriller">Suspense</option>
          <option value="horror">Terror</option>
          <option value="adventure">Aventura</option>
          <option value="historical">Hist\xF3rico</option>
          <option value="non-fiction">N\xE3o Fic\xE7\xE3o</option>
          <option value="self-help">Autoajuda</option>
          <option value="biography">Biografia</option>
          <option value="comic">Hist\xF3ria em Quadrinhos</option>
          <option value="drama">Drama</option>
          <option value="poetry">Poesia</option>
          <option value="children">Literatura Infantil</option>
          <option value="classic">Cl\xE1ssico</option>
          <option value="sci-fi-fantasy">Fic\xE7\xE3o Cient\xEDfica e Fantasia</option>
          <option value="historical-fiction">Fic\xE7\xE3o Hist\xF3rica</option>
       ...
       <select id="age" name="age">
        ...
        <textarea id="postContent" name="postContent" placeholder="Que Leitura voc\xEA gostaria de compartilhar..."></textarea>  
    ...
    btnPublish.addEventListener("click", () => {
      ...
      const userName2 = ((_a2 = getCurrentUser()) == null ? void 0 : _a2.userName) || "Usu\xE1rio Desconhecido";
      ...
      publishPost(Date.now(), book, userName2, genre, age, content).then(createPost);
      modal.style.display = "none";
    });
    return modal;
  }
  ...
  const userName = ((_a = getCurrentUser()) == null ? void 0 : _a.userName) || "Usu\xE1rio Desconhecido";
  containerFeed.innerHTML = `
    ...
    <div id="your-content">
      <button id="your-publication">Qual livro voc\xEA gostaria de compartilhar hoje?</button>
    </div>
